...
1. **Identify scope** — If `$ARGUMENTS` specifies a path, use that. Otherwise look for a `src/` directory in the project root; if none exists, read `CLAUDE.md` to find where source code lives.
