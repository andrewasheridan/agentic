...
2. **Read existing agents** — Scan `.claude/agents/` to understand the existing roster and naming patterns. Read 1–2 similar agents for formatting reference.
...
5. **Scaffold the agent file** — Write `.claude/agents/<agent-name>.md` using this structure:
   ...
   1. **Step one** — ...
   2. **Step two** — ...
   3. **Verify** — Confirm the output is correct before reporting done.
