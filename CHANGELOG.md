...
- Fixed truncated paths in the `task setup` confirmation message by expanding `{{.ROOT_DIR}}` via a shell variable instead of relying on Taskfile template expansion in multiline pipe blocks
